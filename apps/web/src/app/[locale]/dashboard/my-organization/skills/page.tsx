...
export default async function SkillsPage({
  ...
  return (
    <WorkspacePage>
      ...
      {/* No stat row. Every number it showed — general skills, ours, courses,
       * declarations waiting — is already on the tab that leads to the rows it
       * counts, so the cards restated four figures the reader was about to
       * scroll past to reach the same four tabs. Counting something twice on
       * one screen makes both copies worth doubting. */}
      <SkillsWorkspace
