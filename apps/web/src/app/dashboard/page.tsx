...
export default async function DashboardOverview() {
  ...
  const stats = [
    { label: "Organisations", value: c.orgs, href: "/dashboard/organizations" },
    { label: "Places", value: c.places, href: "/dashboard/places" },
    { label: "Services", value: c.services, href: "/dashboard/services" },
    {
