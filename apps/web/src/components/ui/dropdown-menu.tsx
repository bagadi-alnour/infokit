...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "outline-hidden focus:bg-brand-soft focus:text-brand focus:**:text-brand data-inset:ps-7 data-popup-open:bg-brand-soft data-popup-open:text-brand data-open:bg-brand-soft data-open:text-brand flex cursor-default select-none items-center gap-1.5 rounded-md px-1.5 py-1 text-sm [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      {...props}
    >
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "outline-hidden focus:bg-brand-soft focus:text-brand focus:**:text-brand data-inset:ps-7 data-disabled:pointer-events-none data-disabled:opacity-50 relative flex cursor-default select-none items-center gap-1.5 rounded-md py-1 pe-8 ps-1.5 text-sm [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      checked={checked}
      {...props}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground group-focus/dropdown-menu-item:text-brand ms-auto text-xs tracking-widest",
        className,
      )}
      {...props}
    />
